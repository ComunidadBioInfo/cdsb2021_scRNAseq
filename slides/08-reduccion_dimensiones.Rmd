...
Contenido adapatado de: [aqu??](https://docs.google.com/presentation/d/12CjvQ1beZVeCcMQqD6ptzd9YUHbHOksvy3lt_rvWyRs/edit)
...
**PCA descubre las combinaciones (lineales) de "features" que capturan la cantidad m??s grande de variación**
...
La dimensionalidad del output es el límite inferior para el número de PCs requeridos para explicar toda la variación biológica. Lo que significa que cualquier número menor de PCs definitivamente descartar?? algún aspecto de la señal biológica
...
Instructor: [**Laura G??mez-Romero**](http://lgomez.github.io/).
