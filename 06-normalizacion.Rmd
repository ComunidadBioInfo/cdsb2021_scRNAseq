...
```{r all_code, message=FALSE, warning=FALSE, cache=TRUE, include=FALSE}
# Control de calidad
library('scater')
...
hist(log10(deconv.sf.zeisel), xlab = "Log10[Deconvolution size factor]",
    col = "grey80")
...
```{r all_code5, cache=TRUE, dependson='all_code4', message=FALSE, warning=FALSE}
library('Seurat')
# Create a Seurat obj
sce <- sce.zeisel
