...
## --------------------------------------------------------------------------------------------
# pdf(paste0(proydir,"plots/GeneExpression.pdf"))
...
# pdf(paste0(proydir,"plots/ClusteredCells_wIdentity.pdf"))
...
## --------------------------------------------------------------------------------------------
saveRDS(pbmc, file = paste0(proydir, "output/pbmc3k_final.rds"))
