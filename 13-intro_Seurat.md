...
```
## 21:25:24 UMAP embedding parameters a = 0.9922 b = 1.112
```

```
## 21:25:24 Read 2638 rows and found 10 numeric columns
```

```
## 21:25:24 Using Annoy for neighbor search, n_neighbors = 30
```

```
## 21:25:24 Building Annoy index with metric = cosine, n_trees = 50
```
...
```
## **************************************************|
## 21:25:24 Writing NN index file to temp file /tmp/RtmpQn0ZdZ/file55d4e4b01f5
## 21:25:24 Searching Annoy index using 1 thread, search_k = 3000
## 21:25:25 Annoy recall = 100%
## 21:25:26 Commencing smooth kNN distance calibration using 1 thread
## 21:25:26 Initializing from normalized Laplacian + noise
## 21:25:26 Commencing optimization for 500 epochs, with 105140 positive edges
## 21:25:31 Optimization finished
```
