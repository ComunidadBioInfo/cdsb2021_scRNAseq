...
```
## 15:41:53 UMAP embedding parameters a = 0.9922 b = 1.112
```

```
## 15:41:53 Read 2638 rows and found 10 numeric columns
```

```
## 15:41:53 Using Annoy for neighbor search, n_neighbors = 30
```

```
## 15:41:53 Building Annoy index with metric = cosine, n_trees = 50
```
...
```
## **************************************************|
## 15:41:53 Writing NN index file to temp file /tmp/RtmplOxJ9W/file49669fc68c4
## 15:41:53 Searching Annoy index using 1 thread, search_k = 3000
## 15:41:54 Annoy recall = 100%
## 15:41:55 Commencing smooth kNN distance calibration using 1 thread
## 15:41:55 Initializing from normalized Laplacian + noise
## 15:41:55 Commencing optimization for 500 epochs, with 105140 positive edges
## 15:42:00 Optimization finished
```
