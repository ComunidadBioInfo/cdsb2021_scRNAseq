...
```
## 17:58:52 UMAP embedding parameters a = 0.9922 b = 1.112
```

```
## 17:58:52 Read 2638 rows and found 10 numeric columns
```

```
## 17:58:52 Using Annoy for neighbor search, n_neighbors = 30
```

```
## 17:58:52 Building Annoy index with metric = cosine, n_trees = 50
```
...
```
## **************************************************|
## 17:58:53 Writing NN index file to temp file /tmp/RtmpK2KDyp/file474699d534c
## 17:58:53 Searching Annoy index using 1 thread, search_k = 3000
## 17:58:53 Annoy recall = 100%
## 17:58:54 Commencing smooth kNN distance calibration using 1 thread
## 17:58:54 Initializing from normalized Laplacian + noise
## 17:58:54 Commencing optimization for 500 epochs, with 105140 positive edges
## 17:58:58 Optimization finished
```
