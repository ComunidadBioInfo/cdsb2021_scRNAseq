...
```
## 14:18:01 UMAP embedding parameters a = 0.9922 b = 1.112
```

```
## 14:18:01 Read 2638 rows and found 10 numeric columns
```

```
## 14:18:01 Using Annoy for neighbor search, n_neighbors = 30
```

```
## 14:18:01 Building Annoy index with metric = cosine, n_trees = 50
```
...
```
## **************************************************|
## 14:18:01 Writing NN index file to temp file /tmp/RtmpOcLBCb/file4712aaa45d2
## 14:18:01 Searching Annoy index using 1 thread, search_k = 3000
## 14:18:02 Annoy recall = 100%
## 14:18:03 Commencing smooth kNN distance calibration using 1 thread
## 14:18:03 Initializing from normalized Laplacian + noise
## 14:18:03 Commencing optimization for 500 epochs, with 105140 positive edges
## 14:18:08 Optimization finished
```
