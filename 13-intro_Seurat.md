...
```
## 23:11:06 UMAP embedding parameters a = 0.9922 b = 1.112
```

```
## 23:11:06 Read 2638 rows and found 10 numeric columns
```

```
## 23:11:06 Using Annoy for neighbor search, n_neighbors = 30
```

```
## 23:11:06 Building Annoy index with metric = cosine, n_trees = 50
```
...
```
## **************************************************|
## 23:11:07 Writing NN index file to temp file /tmp/RtmpT3ooNT/file54e72598c34
## 23:11:07 Searching Annoy index using 1 thread, search_k = 3000
## 23:11:08 Annoy recall = 100%
## 23:11:08 Commencing smooth kNN distance calibration using 1 thread
## 23:11:09 Initializing from normalized Laplacian + noise
## 23:11:09 Commencing optimization for 500 epochs, with 105140 positive edges
