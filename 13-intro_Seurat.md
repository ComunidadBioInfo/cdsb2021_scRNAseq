...
```
## 00:15:35 UMAP embedding parameters a = 0.9922 b = 1.112
```

```
## 00:15:35 Read 2638 rows and found 10 numeric columns
```
...
```
## **************************************************|
## 00:15:36 Writing NN index file to temp file /tmp/RtmptNShcB/file4ac7112d2bb
## 00:15:36 Searching Annoy index using 1 thread, search_k = 3000
## 00:15:37 Annoy recall = 100%
## 00:15:37 Commencing smooth kNN distance calibration using 1 thread
## 00:15:38 Initializing from normalized Laplacian + noise
## 00:15:38 Commencing optimization for 500 epochs, with 105140 positive edges
## 00:15:42 Optimization finished
```
