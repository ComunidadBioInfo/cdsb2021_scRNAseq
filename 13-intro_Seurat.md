...
```
## 07:57:35 Read 2638 rows and found 10 numeric columns
```
...
```
## **************************************************|
## 07:57:36 Writing NN index file to temp file /tmp/RtmpVmUrbk/file45975db9517
## 07:57:36 Searching Annoy index using 1 thread, search_k = 3000
## 07:57:37 Annoy recall = 100%
## 07:57:37 Commencing smooth kNN distance calibration using 1 thread
## 07:57:37 Initializing from normalized Laplacian + noise
## 07:57:38 Commencing optimization for 500 epochs, with 105140 positive edges
## 07:57:41 Optimization finished
```
