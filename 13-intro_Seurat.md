...
```
## 23:09:17 UMAP embedding parameters a = 0.9922 b = 1.112
```

```
## 23:09:17 Read 2638 rows and found 10 numeric columns
```

```
## 23:09:17 Using Annoy for neighbor search, n_neighbors = 30
```

```
## 23:09:17 Building Annoy index with metric = cosine, n_trees = 50
```
...
```
## **************************************************|
## 23:09:17 Writing NN index file to temp file /tmp/Rtmp8avm3S/file54e4370eabb
## 23:09:17 Searching Annoy index using 1 thread, search_k = 3000
## 23:09:18 Annoy recall = 100%
## 23:09:18 Commencing smooth kNN distance calibration using 1 thread
## 23:09:19 Initializing from normalized Laplacian + noise
## 23:09:19 Commencing optimization for 500 epochs, with 105124 positive edges
## 23:09:22 Optimization finished
```
