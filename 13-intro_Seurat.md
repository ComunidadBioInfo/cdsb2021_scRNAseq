...
```
## 09:04:35 UMAP embedding parameters a = 0.9922 b = 1.112
```

```
## 09:04:35 Read 2638 rows and found 10 numeric columns
```

```
## 09:04:35 Using Annoy for neighbor search, n_neighbors = 30
```

```
## 09:04:35 Building Annoy index with metric = cosine, n_trees = 50
```
...
```
## **************************************************|
## 09:04:35 Writing NN index file to temp file /tmp/Rtmp7Nw3eq/file432794bb77f
## 09:04:35 Searching Annoy index using 1 thread, search_k = 3000
## 09:04:36 Annoy recall = 100%
## 09:04:37 Commencing smooth kNN distance calibration using 1 thread
## 09:04:37 Initializing from normalized Laplacian + noise
## 09:04:37 Commencing optimization for 500 epochs, with 105140 positive edges
## 09:04:41 Optimization finished
```
