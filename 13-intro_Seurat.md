...
```
## 02:08:08 UMAP embedding parameters a = 0.9922 b = 1.112
```

```
## 02:08:08 Read 2638 rows and found 10 numeric columns
```

```
## 02:08:08 Using Annoy for neighbor search, n_neighbors = 30
```

```
## 02:08:08 Building Annoy index with metric = cosine, n_trees = 50
```
...
```
## **************************************************|
## 02:08:09 Writing NN index file to temp file /tmp/RtmpsYRNFj/file4dd70937f94
## 02:08:09 Searching Annoy index using 1 thread, search_k = 3000
## 02:08:09 Annoy recall = 100%
## 02:08:10 Commencing smooth kNN distance calibration using 1 thread
## 02:08:10 Initializing from normalized Laplacian + noise
## 02:08:10 Commencing optimization for 500 epochs, with 105140 positive edges
## 02:08:14 Optimization finished
```
