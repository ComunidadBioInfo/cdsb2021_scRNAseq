...
```
## 15:25:39 UMAP embedding parameters a = 0.9922 b = 1.112
```

```
## 15:25:39 Read 2638 rows and found 10 numeric columns
```

```
## 15:25:39 Using Annoy for neighbor search, n_neighbors = 30
```

```
## 15:25:39 Building Annoy index with metric = cosine, n_trees = 50
```
...
```
## **************************************************|
## 15:25:39 Writing NN index file to temp file /tmp/RtmpONDJ8z/file49e12b368ed
## 15:25:39 Searching Annoy index using 1 thread, search_k = 3000
## 15:25:40 Annoy recall = 100%
## 15:25:40 Commencing smooth kNN distance calibration using 1 thread
## 15:25:41 Initializing from normalized Laplacian + noise
## 15:25:41 Commencing optimization for 500 epochs, with 105124 positive edges
## 15:25:45 Optimization finished
```
