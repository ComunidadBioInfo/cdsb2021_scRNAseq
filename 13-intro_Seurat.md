...
```
## 18:21:25 UMAP embedding parameters a = 0.9922 b = 1.112
```

```
## 18:21:25 Read 2638 rows and found 10 numeric columns
```

```
## 18:21:25 Using Annoy for neighbor search, n_neighbors = 30
```

```
## 18:21:25 Building Annoy index with metric = cosine, n_trees = 50
```
...
```
## **************************************************|
## 18:21:25 Writing NN index file to temp file /tmp/RtmpR7HRSG/file43649342991
## 18:21:25 Searching Annoy index using 1 thread, search_k = 3000
## 18:21:26 Annoy recall = 100%
## 18:21:26 Commencing smooth kNN distance calibration using 1 thread
## 18:21:27 Initializing from normalized Laplacian + noise
## 18:21:27 Commencing optimization for 500 epochs, with 105124 positive edges
